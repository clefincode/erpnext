...
class PaymentEntry(AccountsController):
	...
	def validate_reference_documents(self):
		if self.party_type == "Student":
			valid_reference_doctypes = ("Fees","Service Invoice")
		elif self.party_type == "Customer":
			valid_reference_doctypes = ("Sales Order", "Sales Invoice", "Journal Entry", "Dunning")
		elif self.party_type == "Supplier":
			valid_reference_doctypes = ("Purchase Order", "Purchase Invoice", "Journal Entry")
		elif self.party_type == "Employee":
			valid_reference_doctypes = ("Expense Claim", "Journal Entry", "Employee Advance", "Gratuity" ,"Instructor Invoice")
...
def get_reference_details(reference_doctype, reference_name, party_account_currency):
	...
	if reference_doctype in ("Fees","Service Invoice","Instructor Invoice"):
...
def get_payment_entry(dt, dn, party_amount=None, bank_account=None, bank_amount=None):
	...
	pe.cost_center = doc.get("cost_center") if dt != "Service Invoice" else doc.services[0].cost_center
