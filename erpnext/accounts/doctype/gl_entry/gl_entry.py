...
class GLEntry(Document):
	...
	def on_update(self):
		...
		if not self.flags.from_repost:
			...
			if (self.against_voucher_type in ['Journal Entry', 'Sales Invoice', 'Purchase Invoice', 'Fees', 'Service Invoice', 'Instructor Invoice']
...
def update_outstanding_amt(account, party_type, party, against_voucher_type, against_voucher, on_cancel=False):
	...
	if against_voucher_type in ["Purchase Invoice" ,"Instructor Invoice"]:
		bal = -bal
