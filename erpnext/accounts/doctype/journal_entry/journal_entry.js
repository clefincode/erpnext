...
frappe.ui.form.on("Journal Entry Account", {
	party: async function(frm, cdt, cdn) {
		var d = frappe.get_doc(cdt, cdn);
		var _party_name = ["Student", "Shareholder"].includes(d.party_type) ? "title" : d.party_type.toLowerCase() + "_name";
		var party_name = (await frappe.db.get_value(d.party_type, d.party, _party_name)).message[_party_name];
